...
- Stage changes for review. Make commit in `feature/*' branch for any changes every 8 strings only after my approvement 
...
- `python -m py_compile main.py` return 0 as status code.
